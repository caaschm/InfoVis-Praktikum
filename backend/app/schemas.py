...
class DocumentContentUpdate(BaseModel):
    ...
    ai_suggestion_chapter_id: Optional[str] = None  # Chapter ID to assign new AI sentences to
    chapter_content: Optional[dict[str, str]] = None  # Mapping of chapter_id to its text content
